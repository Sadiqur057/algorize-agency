  ...
  return (
    <main className="relative ">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 h-80 w-80 rounded-full bg-yellow-600/15 blur-3xl"></div>
        <div className="absolute -bottom-24 -right-24 h-72 w-72 rounded-full bg-yellow-500/20 blur-3xl"></div>
      </div>

      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        {/* Header */}
        {/* <div className="mx-auto max-w-3xl text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-yellow-400/10 text-yellow-400 px-3 py-1 text-xs font-medium ring-1 ring-yellow-400/20">
      ...
      {/* Header Section */}
        ...
        <div className="hidden md:block">
          ...
          {/* Highlighted row */}
          <div className="mt-4 rounded-2xl bg-gradient-to-br from-yellow-700/20 via-yellow-600/10 to-transparent ring-1 ring-yellow-400/30 p-1 shadow-[0_0_40px_rgba(250,204,21,0.15)]">
            <div className="grid grid-cols-8 items-center rounded-2xl bg-gray-900/80">
              <div className="col-span-3 flex items-start gap-4 p-5">
                <div className="h-11 w-11 shrink-0 grid place-items-center rounded-xl bg-yellow-400/20 ring-1 ring-yellow-400/30">
        ...
        <div className="mt-10 space-y-6 md:hidden">
          {/* Card: Design Monks */}
          <div className="rounded-2xl bg-gradient-to-br from-yellow-700/20 via-yellow-600/10 to-transparent ring-1 ring-yellow-400/30 p-1 shadow-[0_0_40px_rgba(250,204,21,0.15)]">
            <div className="rounded-2xl bg-gray-900/80 p-5">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3">
                <div className="flex items-center gap-2 rounded-lg bg-gray-800/60 px-3 py-2">
                  ...
                  <Check className="ml-auto h-4 w-4 text-yellow-400" />
                </div>
                <div className="flex items-center gap-2 rounded-lg bg-gray-800/60 px-3 py-2">
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-3">
          <a href="#" className="inline-flex items-center gap-2 rounded-xl bg-yellow-400 text-black px-5 py-3 text-sm font-semibold ring-1 ring-yellow-400/30 hover:bg-yellow-300 transition-colors shadow-[0_0_30px_rgba(250,204,21,0.3)]">
