...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className="" onClick={onClick} />
  ) : (
    <IconMenu2 className="" onClick={onClick} />
  );
};
  ...
  return (
    ...
    >
      {/* <img
        ...
        height={30}
      /> */}
      <span className="font-medium">Techforge</span>
    </Link>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    gradient:
      "bg-gradient-to-b from-blue-300 to-blue-600 text-white shadow-[0px_2px_0px_0px_rgba(255,255,255,0.3)_inset]",
  };
